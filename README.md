...
If you want to play it, you can go to the URL: https://nicolasjao.github.io/Galaxy_on_Flames/

You can also download the entire repository, all into one folder on your local computer, then open the index.html file on your browser. You can use the "download zip" option from the green button that says code. Have fun!
